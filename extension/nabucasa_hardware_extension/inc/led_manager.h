...
typedef enum {
    ...
    LED_PRIORITY_MANUAL,         // User command / Zigbee Cluster (The "Backup" color)
    LED_PRIORITY_NOTIFICATION,   // Short feedback (Green blink on join, Identify)
    LED_PRIORITY_CRITICAL,       // Tilt, Factory Reset
    LED_PRIORITY_COUNT
} led_priority_t;
